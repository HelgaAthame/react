...
export class FormPage extends Component<ReactPropTypes, FormStateType> {
  ...
  handleDateChange(event: ChangeEvent<HTMLInputElement>) {
    ...
    let bd = new Date(event.target.value);
    let birthdayThisYear = new Date(today.getFullYear(), bd.getMonth(), bd.getDate());
  ...
  validateName(value: string | undefined, el: RefObject<HTMLInputElement>) {
    if (!value || value.length > 50 || value.length < 2 || value.match(/[\d\s!\*\\@#$%\^\|\~\?\&\(\)\-\+\=\,\.]/)) {
  ...
  validateAddress() {
    if (!this.state.address || this.state.address.length > 100 || this.state.address.length < 10 || this.state.address.match(/[\!\*\\@#\$%\^\|\~\?\&\(\)\+\=]/)) {
      ...
      <section className="form-page">
        ...
        <Form submitFunc={this.handleSubmit.bind(this)}>
          <Fieldset title="Personal Information">
            <Input id="firstName" value={this.state.firstName} label="First Name" type="text" handleChange={this.handleInputChange.bind(this)} ref={this.firstName}/>
            <Input id="lastName" value={this.state.lastName} label="Last Name" type="text" handleChange={this.handleInputChange.bind(this)} ref={this.lastName}/>
            <Input id="age" label="Birthday" type="date" value={this.state.birthday} handleChange={this.handleDateChange.bind(this)} ref={this.age}/>
          ...
          <Fieldset title="Address">
            <Input id="zipCode" value={this.state.zipCode} label="Zip-code" type="text" handleChange={this.handleInputChange.bind(this)} ref={this.zipCode}/>
            <Select
              id="country"
              multiple={false}
              label="Country"
              ...
              ref={this.country}
            />
            <Input id="city" label="City" value={this.state.city} type="text" handleChange={this.handleInputChange.bind(this)} ref={this.city}/>
            <Input id="address" label="Address" value={this.state.address} type="text" handleChange={this.handleInputChange.bind(this)} ref={this.address}/>
          </Fieldset>

          <Fieldset title="Contacts">
            <Input id="email" value={this.state.email} label="E-mail" type="text" handleChange={this.handleInputChange.bind(this)} ref={this.email}/>
            ...
            <Input id="phone" value={this.state.phone} label="Phone" type="text" handleChange={this.handleInputChange.bind(this)} ref={this.phone}/>
