...
class SearchBar extends Component<SearchBarProps> {
  ...
  handleBlur () {
    if (this.wrapper.current && this.input && document.activeElement !== this.input.current) this.wrapper.current.style.flexGrow = '0';
  }

  render () {
    return (
      <div className='wrapper'>
        <div ref={this.wrapper} className="search_wrapper"
          ...
          <input
            ...
            onBlur={this.handleBlur.bind(this)} required />
        </div>
      </div>
    )
  }
